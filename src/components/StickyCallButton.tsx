            ...
            <div className="p-6">
              ...
              >
                <div className="space-y-1.5">
                  ...
                  <input type="text" required className="w-full px-4 py-3 rounded-sm border-2 border-slate-200 focus:border-secondary focus:bg-slate-50 outline-none transition-all font-bold text-slate-800 bg-slate-50 text-sm" placeholder="John Doe" />
                </div>
                
                <div className="space-y-1.5">
                  <label className="block text-[11px] font-black text-slate-500 uppercase tracking-widest">Phone Number</label>
                  <input type="tel" required className="w-full px-4 py-3 rounded-sm border-2 border-slate-200 focus:border-secondary focus:bg-slate-50 outline-none transition-all font-bold text-slate-800 bg-slate-50 text-sm" placeholder="(318) 555-5555" />
                </div>

                <div className="space-y-1.5">
                  <label className="block text-[11px] font-black text-slate-500 uppercase tracking-widest">Priority Service</label>
                  <select className="w-full px-4 py-3 rounded-sm border-2 border-slate-200 focus:border-secondary focus:bg-slate-50 outline-none transition-all font-bold text-slate-800 bg-slate-50 appearance-none text-sm cursor-pointer">
                ...
                <div className="space-y-1.5 pb-2">
                  ...
                  <textarea rows={3} className="w-full px-4 py-3 rounded-sm border-2 border-slate-200 focus:border-secondary focus:bg-slate-50 outline-none transition-all font-bold text-slate-800 bg-slate-50 resize-none text-sm" placeholder="Example: 3 rooms near Pineville..."></textarea>
                </div>

                <button type="submit" className="w-full bg-secondary hover:bg-red-700 active:scale-95 text-white font-black py-4 rounded-sm shadow-xl transition-all flex items-center justify-center gap-3 uppercase tracking-widest text-sm">

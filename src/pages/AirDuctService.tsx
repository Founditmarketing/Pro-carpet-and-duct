...
import { Phone, Wind, Zap, ShieldCheck } from 'lucide-react';
import { useLocation } from 'react-router-dom';
import PageSEO from '../components/PageSEO';
import { breadcrumbSchema, localBusinessRef } from '../utils/schema';

const AirDuctService: React.FC = () => {
  ...
  const schema = [
    {
      ...
      description: "Professional HVAC air duct cleaning removes trapped dust, allergens, mold, and construction debris from your home's ductwork.",
      serviceType: 'Air Duct Cleaning Service',
    },
    breadcrumbSchema([
      { name: 'Home', path: '/' },
      { name: 'Air Duct Cleaning', path: '/air-duct' },
    ]),
  ];
  ...
  return (
    <main className="pb-0 animate-fade-in-up">
      <PageSEO
        title="Air Duct Cleaning Alexandria & Pineville, LA | Pro Carpet & Duct Cleaning"
        description="Professional air duct cleaning removes trapped dust, allergens & mold from your HVAC system. Serving Alexandria & Pineville, LA since 1985. Free quotes."
        path="/air-duct"
        schema={schema}
      />
      {/* Slim Hero Section */}
      <section className="bg-primary text-white pt-40 pb-20 px-4 relative overflow-hidden hidden md:block border-b border-white/10">
        <div className="container mx-auto relative z-10 text-center max-w-4xl pt-8 pb-4">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold mb-6 drop-shadow-lg">Professional Air Duct Cleaning</h1>
          <p className="text-lg md:text-xl text-slate-200 font-medium max-w-2xl mx-auto leading-relaxed drop-shadow-md">
            Remove years of trapped dust, allergens, and construction debris from your home's respiratory system.
          </p>
        </div>
      </section>
      ...
      <section className="bg-primary text-white pt-36 pb-16 px-4 relative overflow-hidden md:hidden border-b border-white/10">
        <div className="container mx-auto relative z-10 text-center">
          ...
          <h1 className="text-3xl font-serif font-bold mb-4 leading-tight drop-shadow-lg">Professional Air Duct Cleaning</h1>
          <p className="text-sm text-slate-200 font-medium drop-shadow-md">
             Remove trapped dust, allergens, and debris from your home's respiratory system.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-28 px-4 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            {/* Left Col: Text */}
            <div>
              <h2 className="text-3xl md:text-4xl font-serif font-bold text-slate-900 mb-6 leading-tight">Why Clean Air Ducts Matter</h2>
              ...
              <p className="text-slate-600 text-base md:text-lg mb-8 leading-relaxed">
                Your air ducts act as the lungs of your home. Over years of use, they collect massive amounts of pet dander, pollen, mold spores, and microscopic dust mites. Every time your air conditioner kicks on, those contaminated particles are circulated directly into the air your family breathes.
              </p>
              ...
              <ul className="space-y-6 md:space-y-8 mb-8">
                <li className="flex items-start gap-4 p-4 md:p-6 rounded-lg bg-slate-50 border border-slate-100 hover:border-secondary/30 transition-colors group">
                  ...
                  <div>
                    <strong className="text-slate-900 block mb-1 text-lg">Massive Allergen Reduction</strong>
                    <span className="text-slate-600 text-sm md:text-base leading-relaxed">We physically dislodge and extract deeply embedded particulate matter, drastically improving indoor air quality for allergy and asthma sufferers.</span>
                  </div>
                </li>
                ...
                <li className="flex items-start gap-4 p-4 md:p-6 rounded-lg bg-slate-50 border border-slate-100 hover:border-secondary/30 transition-colors group">
                  ...
                  <div>
                    <strong className="text-slate-900 block mb-1 text-lg">Restored HVAC Efficiency</strong>
                    <span className="text-slate-600 text-sm md:text-base leading-relaxed">A heavy buildup of dust creates friction in your system. Cleaning the ductwork removes obstructions, lowering your energy bills and extending the life of your unit.</span>
                  </div>
                </li>
                
                <li className="flex items-start gap-4 p-4 md:p-6 rounded-lg bg-slate-50 border border-slate-100 hover:border-secondary/30 transition-colors group">
                  <div className="p-2 bg-white rounded shadow-sm group-hover:bg-secondary/10 transition-colors">
                    <Wind className="w-6 h-6 text-secondary shrink-0" />
                  </div>
                  <div>
                    <strong className="text-slate-900 block mb-1 text-lg">Comprehensive Sanitization</strong>
                    <span className="text-slate-600 text-sm md:text-base leading-relaxed">Beyond basic sweeping, our negative air process pulls contaminants out entirely, leaving behind a fresh, sanitized airflow throughout the entire house.</span>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="relative">
              ...
              <img 
                src="/procarpetducts.jpg" 
                alt="Professional Air Duct Cleaning Equipment" 
              ...
              <div className="absolute -bottom-6 md:bottom-8 left-1/2 -translate-x-1/2 md:translate-x-0 md:-left-12 bg-white p-4 md:p-6 rounded-lg shadow-xl border-t-4 md:border-t-0 md:border-l-4 border-secondary flex items-center gap-4 z-20 w-[90%] md:w-auto">
                <div className="bg-primary/5 p-3 rounded-full shrink-0">
                  <Wind className="w-6 h-6 md:w-8 md:h-8 text-secondary" />
                </div>
                <div>
                  <div className="font-bold text-slate-900 text-base md:text-xl">Breathe Easier</div>
                  <div className="text-slate-500 text-xs md:text-sm font-medium">Complete Indoor Air Sanitization</div>
                </div>
              </div>
            </div>
      ...
      <section className="bg-secondary text-white py-16 md:py-24 px-4 relative mt-12 md:mt-0">
        <div className="container mx-auto text-center relative z-10">
          ...
          <p className="text-white/90 max-w-2xl mx-auto mb-10 text-base md:text-lg font-medium drop-shadow-sm">
            Don't let dirty ducts ruin your indoor air quality. Call the most trusted name in Alexandria for a free quote today.
          </p>
